    ...
    <section id="projects" className="py-20 bg-neutral-900 relative">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-blue-500 rounded-full filter blur-3xl"
        />
      </div>
      ...
      <div className="container mx-auto px-6">
        ...
        {projectsData.length > 4 && (
          <div className="text-center mt-12">
            <Link 
              href="/projects" 
              className="inline-block bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-500 transition-colors duration-300"
            >
              View All Projects
            </Link>
          </div>
