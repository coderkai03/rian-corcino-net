  ...
  return (
    ...
    >
      <div className={`flex flex-col md:flex-row items-center ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
        {/* Timeline Dot */}
        <div className="absolute left-1/2 transform -translate-x-1/2 w-5 h-5 bg-blue-600 rounded-full border-4 border-neutral-900 hidden md:block"></div>

        {/* Content Card */}
        <div className="w-full md:w-5/12 mb-8 md:mb-0">
          <div className="bg-neutral-800 p-6 rounded-lg shadow-lg border border-neutral-700 hover:shadow-xl transition-shadow duration-300 h-full">
