  ...
  return (
    ...
    >
      <div className={`flex flex-col md:flex-row items-center ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
        {/* Timeline Dot */}
        <div className="absolute left-1/2 transform -translate-x-1/2 w-5 h-5 bg-yellow-400 rounded-full border-4 border-gray-900 hidden md:block shadow-lg shadow-yellow-400/50"></div>

        {/* Content Card */}
        <div className="w-full md:w-5/12 mb-8 md:mb-0">
          <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-yellow-400/20 hover:shadow-xl hover:border-yellow-400/40 transition-all duration-300 h-full">
